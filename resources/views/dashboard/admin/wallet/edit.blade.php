                        ...
                        <form action="{{ route('admin.wallet.update', $wallet->uuid) }}" method="POST"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control @error('address') is-invalid @enderror"
                                        id="address" name="address" value="{{ old('address', $wallet->address) }}"
                                        maxlength="100" required>
                                    @error('address')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @if ($wallet->image)
                                        <div class="mt-2">
                                            <img src="{{ asset($wallet->image) }}" alt="Current Image" class="img-thumbnail"
                                                width="200">
                                        </div>
                                    @endif
                                    @error('image')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    @if ($wallet->logo)
                                        <div class="mt-2">
                                            <img src="{{ asset($wallet->logo) }}" alt="Current Logo" class="img-thumbnail"
                                                width="150">
                                        </div>
                                    @endif
                                    @error('logo')
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="number" step="0.01"
                                        ...
                                        name="price" value="{{ old('price', $wallet->price) }}">
                                    @error('price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
