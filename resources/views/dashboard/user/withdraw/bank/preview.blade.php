                ...
                <div class="card mb-4 shadow-sm">
                    ...
                    <div class="card-body">
                        <dl class="row mb-0">
                            ...
                            <dd class="col-sm-8">{{ $withdrawal->account_name ?? 'N/A' }}</dd>

                            <dt class="col-sm-4">Account Number:</dt>
                            <dd class="col-sm-8">{{ $withdrawal->account_number ?? 'N/A' }}</dd>

                            <dt class="col-sm-4">Bank Name:</dt>
                            <dd class="col-sm-8">{{ $withdrawal->bank_name ?? 'N/A' }}</dd>

                            <dt class="col-sm-4">Routing Number:</dt>
                            <dd class="col-sm-8">{{ $withdrawal->routing_number ?? 'N/A' }}</dd>
                        </dl>
                    </div>
                </div>
