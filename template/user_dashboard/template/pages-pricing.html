...
<!-- Mirrored from coderthemes.com/osen/layouts/pages-pricing.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 20 Mar 2025 15:28:19 GMT -->
<head>
    <meta charset="utf-8" />
    <title>Pricing One | Osen - Responsive Bootstrap 5 Admin Dashboard</title>
            ...
            <div class="page-container">
                ...
                <div class="page-title-head d-flex align-items-sm-center flex-sm-row flex-column gap-2">
                    <div class="flex-grow-1">
                        <h4 class="fs-18 fw-semibold mb-0">Pricing One</h4>
                    </div>
                    ...
                    <div class="text-end">
                        <ol class="breadcrumb m-0 py-0">
                            ...
                            <li class="breadcrumb-item active">Pricing One</li>
                        </ol>
                    </div>
                </div>
